        ...
        <header
            ...
            <div class="flex items-center gap-4">
                <div>
                    ...
                    <p class="text-xs text-slate-500 mt-0.5">Managing <span
                            class="font-bold text-indigo-600">{{ $students->count() }}</span> active students</p>
                </div>
            </div>
            ...
            <div class="flex items-center gap-3">
                <div class="relative hidden sm:block">
                    ...
                    <input type="text" placeholder="Search students..."
                        class="pl-9 pr-4 py-2 rounded-lg border border-slate-200 text-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 transition-all w-64">
                </div>
            ...
            <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                @forelse($students as $student)
                    <div
                        ...
                        <div class="flex items-start justify-between mb-6">
                            ...
                            <button
                                class="text-slate-300 hover:text-slate-600 p-1 rounded-full hover:bg-slate-50 transition-colors">
                        ...
                        <div class="flex gap-3">
                            <button
                                class="flex-1 py-2.5 bg-white border border-slate-200 text-slate-600 text-xs font-bold rounded-lg hover:border-indigo-300 hover:text-indigo-600 transition-all shadow-sm">
                                View Profile
                            </button>
                            <button
                                class="flex-1 py-2.5 bg-indigo-50 border border-indigo-100 text-indigo-700 text-xs font-bold rounded-lg hover:bg-indigo-100 transition-all shadow-sm">
                                Statistics
                            </button>
                        </div>
                ...
                @empty
                    <div class="col-span-full py-20 text-center bg-white border border-dashed border-slate-200 rounded-2xl">
                        ...
                        <button onclick="openModal()" class="mt-4 text-indigo-600 text-sm font-bold hover:underline">Add
                            your first student</button>
                    </div>
                @endforelse
            ...
            <div class="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
                ...
                <div
                    ...
                    <button onclick="closeModal()"
                        class="absolute top-5 right-5 text-slate-400 hover:text-slate-600 bg-slate-50 rounded-lg p-1 transition-colors">
                    ...
                    <div class="px-8 pb-8 pt-8">
                        ...
                        <form id="form-manual" action="{{ route('teacher.students.store') }}" method="POST"
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    <label class="block text-xs font-bold text-slate-500 uppercase mb-1.5 ml-1">First
                                        Name</label>
                                ...
                                <div>
                                    <label class="block text-xs font-bold text-slate-500 uppercase mb-1.5 ml-1">Last
                                        Name</label>
                            ...
                            <div>
                                <label class="block text-xs font-bold text-slate-500 uppercase mb-1.5 ml-1">Email
                                    Address</label>
                                <div class="relative">
                                    <i data-lucide="mail"
                            ...
                            <div class="bg-blue-50 p-4 rounded-xl flex items-start gap-3 border border-blue-100">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-blue-600 mt-0.5">The temporary password will be
                        ...
                        <form id="form-import" action="{{ route('teacher.students.store') }}" method="POST"
                            ...
                            <div
                                class="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-slate-300 px-6 py-10 hover:bg-slate-50 hover:border-indigo-300 transition-all group cursor-pointer relative">
                                <div class="text-center">
                                    <div
                                        class="w-12 h-12 bg-indigo-50 rounded-full flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform">
                            ...
                            <div class="bg-slate-50 p-4 rounded-xl border border-slate-200">
                                <p class="text-[10px] font-bold text-slate-400 uppercase mb-2">Required Columns</p>
